...
function Landing () {
  ...
  return (
    <>
      ...
      <Header />
      <Main>
        <section className='h-[100vh] w-full font-netflix-medium text-white flex flex-col justify-center items-center px-[33px] z-0'>
          ...
          <ul className='mt-10 w-[80%] flex flex-col gap-3'>
            ...
            <li className='w-full  h-auto relative min-h-10'>
              <ButtonInformation title='Dónde puedo ver Netflix?'>
                ...
                multimedia y consolas de juegos.{<br />}
                {<br />}
            ...
            <li className='w-full  h-auto relative min-h-10'>
              <ButtonInformation title='¿Es bueno Netflix para los niñox?'>
                ...
                los niños en función de la clasificación por edad y bloquear
        ...
        <section className=' py-10 px-40 max-h-auto  bg-black border-t-8 border-gray-400/60 text-gray-400 text-sm relative flex flex-col items-center sm:items-start'>
